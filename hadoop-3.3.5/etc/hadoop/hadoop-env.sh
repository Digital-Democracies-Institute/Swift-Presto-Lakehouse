...
export HADOOP_CLASSPATH=$HADOOP_CLASSPATH:$HADOOP_HOME/share/hadoop/tools/lib/hadoop-aws-3.3.5.jar:$HADOOP_HOME/share/hadoop/tools/lib/aws-java-sdk-bundle-1.12.316.jar
